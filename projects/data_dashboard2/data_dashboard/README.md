...
Link in case the above doesn't work: https://imgur.com/a/QpSCbx7
...
One of my biggest challenges was getting the graphs to display properly. The data part was easy but I struggled to show the bar graphs. It was also a challenge to align the graphs how I wanted. After some trial and error, I decided to go with the graphs displayed stacked on top of each other to the right of the table.
